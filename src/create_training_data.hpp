...
inline void popup_create_training_data_select(nlohmann::json const &config,
    ...
    switch (selectedOption) {
        case 0:
            selected_compression_data(config, language, metadata, inputvin,
                                      mileage, comment, api_message,
                                      upload_success);
            break;
        case 1:
            selected_battery_measurement(config, language, metadata, inputvin,
                                         mileage, comment, api_message,
                                         upload_success);
            break;
        case 2:
            selected_vcds_data(config, language, metadata, inputvin, mileage,
