...
static void
popup_settings(nlohmann::json& config, nlohmann::json& language, std::string const& configpath) {
    ...
    ImGui::TextUnformatted(load_json<std::string>(language, "settings", "buttonexplain").c_str());
