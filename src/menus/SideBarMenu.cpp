...
static void
SetSideBarMenu(nlohmann::json &language,
               std::vector<std::string> &availableLanguages,
               nlohmann::json &config, const std::string &configpath,
               bool &open_settings, std::optional<OmniscopeSampler> &sampler,
  ...
  // set the menu to the left side of the window ; important size in
  // percentage!
  ...
  if (!loaded_png) {
    bool ret = LoadTextureFromHeader(AutoInternLogo_png, AutoInternLogo_png_len,
